...
<head>
    ...
    <title>Daftar Report UKGS</title>
...
<body class="hold-transition sidebar-mini layout-fixed-dark-">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="d-flex row mb-2">
                        <h1 class="m-0">Daftar Seluruh Ticket Pendaftaran</h1>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            <!-- /.content-header -->
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header bg-warning">
                                    <h3 class="card-title">
                                        <dt>All Ticket (Approve, Reject, Reschedule)</dt>
                                    </h3>
                                    <!--
                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <!--
                                        <form class="row g-3" action="report.php" method="GET">
                                            <div class="col-auto">
                                                <?php
                        $vfil = array('all' => 'All', '4' => 'Finish', '3' => 'Reject', '2' => 'Reschedule');
                        ...
                        //   if ($_POST['status-data'] == 'all') {
                        //     $filter = "SELECT * FROM pendaftaran WHERE kode_sekolah = '$kode_sekolah'";
                        //   } else if ($_POST['status-data'] == 2) {
                        //     $filter = "SELECT * FROM pendaftaran WHERE status = 2 AND kode_sekolah = '$kode_sekolah'"; //reject
                        //   } else if ($_POST['status-data'] == 3) {
                        //     $filter = "SELECT * FROM pendaftaran WHERE status = 3 AND kode_sekolah = '$kode_sekolah'"; // reschedule
                        //   } else if ($_POST['status-data'] == 4) {
                        //     $filter = "SELECT * FROM pendaftaran WHERE status = 4 AND kode_sekolah = '$kode_sekolah'"; // Finish (Lewat Tanggal)
                        //   }
                        // } else {
                        //   $filter = "SELECT * FROM pendaftaran WHERE kode_sekolah = '$kode_sekolah'";
                        // }
    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <form class="row g-3" action="report.php" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title">Pilihan Filter</h6>
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            ordering: false,
            ajax: {
                "url": "tables_report.php?status=<?= $_POST["status-data"]; ?>",
                "dataType": "json",
                "type": "POST"
            },
            columns: [
