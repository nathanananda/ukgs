...
// ambil data 2 hari
$now = date('Y-m-d');
$kemarin = date('Y-m-d', strtotime('-' . 1 . 'days', strtotime($now)));
$range = new DateTime($kemarin);
$date_plus = $range->modify("+2 days");
$date_range = $date_plus->format("Y-m-d");
// query data siswa berdasarkan sekolah
$list = query("SELECT * FROM pendaftaran WHERE kode_sekolah = '$kode_sekolah' AND status = '$default' OR status = '$konfirmasi'");
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
              ...
              with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="finalisasi.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Finalisasi Ticket Pelayanan UKGS</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header bg-warning">
                                    <h3 class="card-title">
                                        <dt>Daftar Ticket Finalisasi</dt>
                                    </h3>
                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <!--
                                        <form class="row g-3" action="finalisasi.php" method="GET">
                                            <div class="col-auto">
                                                <?php
                          $vfil = array(
                          'all' => 'All',
                          ...
                          'D10' => 'SDK 10 PENABUR',
                          'D11' => 'SDK 11 PENABUR',
                          'DJB' => 'SDK PENABUR KOTA JABABEKA',
                          'DGS' => 'SDK PENABUR GADING SERPONG',
                          'DKM' => 'SDK PENABUR KOTA MODERN',
                          'DHI' => 'SDK PENABUR HARAPAN INDAH',
                          'DBJ' => 'SDK PENABUR BINTARO JAYA',
                          'DAS' => 'SDK PENABUR AGUS SALIM',
                          'DKW' => 'SDK PENABUR KOTA WISATA',
                          'DSB' => 'SDK PENABUR SUMMARECON BEKASI',
                          'DDP' => 'SDK PENABUR DEPOK',
                          'DKGI' => 'SDK PENABUR KELAPA GADING INTER'
                        );
                        echo '<select name="status-data" class="form-select" aria-label="Default select example">';
                        foreach ($vfil as $a => $b) {
                          if ($_POST['status-data'] == $a) {
    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <form class="row g-3" action="finalisasi.php" method="POST">
                <!-- Modal content-->
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="submit" class="btn btn-primary" data-toggle="modal"
                            data-target="#modal-primary">Save changes</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    $(document).ready(function() {
        $('#table-data').DataTable({
            ...
            ordering: false,
            ajax: {
                "url": "tables_finalisasi.php?status-data=<?= $_POST["status-data"]; ?>",
                "dataType": "json",
                "type": "POST"
            },
            columns: [
